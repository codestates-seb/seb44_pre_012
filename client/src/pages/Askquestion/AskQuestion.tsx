...
export default function Askquestion() {
  ...
  const stepsList = [
    ...
    {description: 'Add “tags” which help surface your question to members of the community.'},
    ...
    <S.AskQuestionPage>
      ...
      <S.QuestionExplain>
        <div>
          ...
          <p>You’re ready to <span style={{ color: 'var(--color-searchBtn)' }}>ask</span> a <span style={{ color: 'var(--color-searchBtn)' }}>programming-related question</span> and this form will help guide you through the process.</p>
          <p>Looking to ask a non-programming question? See <span style={{ color: 'var(--color-searchBtn)' }}>the topics here</span> to find a relevant site.</p>
          <h5>Steps</h5>
          <ul>
          ...
          {currentStep < 3 && <S.LeftsideOverlay isFocus={isFocus}/>}
            <S.Leftcontainer>
              <S.Leftcontainerwrapper>
                ...
                {currentStep > 2 && <S.NextBtn onClick={handleNextStep}>Next</S.NextBtn>}
              </S.Leftcontainerwrapper>
            </S.Leftcontainer>
          </S.Leftside>
          <QuestionSidebar 
...
function QuestionSidebar ( {title, text, isFocus}:QuestionSidebarProps & IsFocusProps) {
  return (
    <S.QuestionSidebar isFocus={isFocus}>
      <S.QuestionSidebarTitle>
        {title}
      </S.QuestionSidebarTitle>
...
const S = {
  ...
  LeftsideOverlay: styled.div <IsFocusProps>`
    ...
    border-radius: 3px;
    border-width: 1px;
    cursor: ${(props: IsFocusProps) => (props.isFocus ? "cursor" : "not-allowed")};
  `,
  Leftside: styled.div`
    max-width: 851px;
    width: 100%;
